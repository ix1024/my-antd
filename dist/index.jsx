...
const { Input, InputGroup, InputNumber, InputNumberRange, TextArea, Radio, Select, DatePicker, Reset, Upload, Switch, Button, FormItem, MyEmpty, MyCard, MyModal, MyInfo, MyUpload, MyTable, MyPagination, message, MyBreadcrumb, DisabledSwitch, Delete, NotDelete, } = MyAntd;
exports.Input = Input;
...
exports.MyBreadcrumb = MyBreadcrumb;
